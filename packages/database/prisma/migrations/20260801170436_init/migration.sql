...
-- CreateIndex
CREATE UNIQUE INDEX "ProductCategory_householdId_name_key" ON "ProductCategory"("householdId", "name");

-- CreateIndex
CREATE INDEX "Product_householdId_name_idx" ON "Product"("householdId", "name");

-- CreateIndex
CREATE UNIQUE INDEX "Product_householdId_name_brand_key" ON "Product"("householdId", "name", "brand");

-- CreateIndex
CREATE INDEX "InventoryItem_householdId_consumedAt_idx" ON "InventoryItem"("householdId", "consumedAt");

-- CreateIndex
CREATE INDEX "InventoryItem_householdId_productId_consumedAt_expirationDa_idx" ON "InventoryItem"("householdId", "productId", "consumedAt", "expirationDate");
...
-- AddForeignKey
ALTER TABLE "ProductCategory" ADD CONSTRAINT "ProductCategory_householdId_fkey" FOREIGN KEY ("householdId") REFERENCES "Household"("id") ON DELETE CASCADE ON UPDATE CASCADE;
